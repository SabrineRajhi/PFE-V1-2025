...
const CardListCours = () => {
  ...
  {cours.map((coursItem) => (
    <tr key={coursItem.idespac}>
      ...
      <td>
        <img src="/path/to/course-icon.png" alt="Course" className="course-icon" />
      </td>
            ...
            <div className="modal-overlay">
              <div className="modal-content">
                <form onSubmit={handleSubmitCours}>
                  ...
                  <div>
                    {typeElementId === '2' && <img src="/pdf-icon.png" alt="PDF" />}
                    {/* {typeElementId === '4' && <img src="/word-icon.png" alt="Document Word" />} */}
                    {typeElementId === '5' && <img src="/word-icon.png" alt="Document Word" />}
                    {typeElementId === '1' && <img src="/image-icon.png" alt="Image" />}
                  </div>
